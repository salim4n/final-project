export const generateDailyMeals = (mealsAlreadyUsed: string[], totalCalories: number, proteinRatio: number, carbohydrateRatio: number, fatRatio: number, dietType: string, intolerances: string[], includeBreakfast: boolean) => {
    return `
